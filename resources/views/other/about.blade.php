<x-app-layout>
    ...
    <section class="text-center">
            ...
            <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
                Our mission is to provide a place for people to voice their opinions and to incorporate those opinions into school improvement.
            </p>
            ...
            <div class="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg max-w-lg">
                <div class="flex mb-4">
                    <img
                        ...
                        src="https://avatars0.githubusercontent.com/u/52205108?s=460&amp;u=0667510c252aaa7352707d952480fe7baeafb9b6&amp;v=4"
                    />
                ...
                <p class="text-gray-800 dark:text-gray-100 leading-snug md:leading-normal">
                    I hope that this web application will be used by many more people and that our students will make our school a better place!<br />
