        ...
        <div class="mt-10">
            <div class="mx-2">
                <a
                    ...
                    class="text-center p-2 rounded bg-blue-500 text-white block hover:bg-blue-400focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                    一般モード
                </a>
            </div>
            <div class="mt-10">
                ...
                <x-admin.header-nav-link link="admin.announcements" value="お知らせ管理">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
