<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="p-6 mt-6 text-gray-500">
        ...
        <a href="{{ config('opinion-box.github.license') }}" class="link">
            Apache-2.0 License
        </a>
    ...
    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
        ...
        <div class="mt-6 text-gray-500">
            {{ __('さあ、OpinionBoxを使用してみましょう。') }}<br/>
            {{ __('Boxに意見を入れる方法は簡単です。以下のリンクよりフォームに意見を入力し送信するだけです。') }}<br/>
    ...
    <div class="p-6 sm:px-20 bg-white border-gray-200">
        ...
        <div class="mt-6 text-gray-500">
            {{ __('OpinionBoxでは開発チームを募集しています。') }}
            <a href="{{ config('opinion-box.github.discussions') }}" class="link" target="_blank">
                {{ __('GitHubのdiscussions') }}
            </a>
            {{ __('より参加の意思表示を行ってください。') }}<br/>
            {{ __('私たちはみなさんがコントリビュータとしてまた会えることを心待ちにしています。') }}
        </div>
    </div>
</div>
