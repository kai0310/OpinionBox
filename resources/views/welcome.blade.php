        ...
        <div class="relative bg-white shadow-lg sm:rounded-3xl">
            ...
            <div class="px-20 py-6">
                    ...
                    <div class="sm:flex items-center justify-center">
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="px-6 py-3 rounded-3xl font-medium bg-gradient-to-b from-gray-900 to-black text-white outline-none focus:outline-none hover:shadow-md hover:from-true-gray-900 transition duration-200 ease-in-out">Register</a>
                            @endif
                        @endauth
                    </div>
                </div>
                ...
                <div class="lg:2/6 xl:w-2/4 my-20 lg:my-40 lg:ml-16 text-left">
                    <div class="text-5xl text-gray-900 leading-none">From Your Opinion<br />to Big Impact</div>
                    <div class="my-6 text-xl font-light text-true-gray-400 antialiased">OpinionBoxを用いて私たちで学校に改革を起こしませか？</div>
                    <a href="{{ route('login') }}" class="mt-6 px-8 py-4 rounded-full font-normal tracking-wide bg-gradient-to-b from-blue-600 to-blue-700 text-white outline-none focus:outline-none hover:shadow-lg hover:from-blue-700 transition duration-200 ease-in-out">
