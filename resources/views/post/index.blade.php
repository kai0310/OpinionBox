<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="px-4 sm:px-0">
            <h1 class="text-xl font-bold text-gray-700 md:text-2xl">もっとOpinionBoxを活用しよう</h1>
            <p class="mt-2 text-gray-600">OpinionBoxはよりたくさんの意見を集約し、改善されるように様々な機能があります。<br />OpinionBoxを用いて私たちでより良い学校へとしましょう。</p>
        </div>
            ...
            <div class="flex flex-wrap -m-4">
                ...
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-300 p-6 rounded-lg bg-white">
                        ...
                        <h2 class="text-lg  font-medium title-font mb-2">コメントをしてみよう</h2>
                        <p class="leading-relaxed text-base">OpinionBoxでは公開中の意見にコメントをすることもできます。</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="mt-6">
                    <div class="mx-auto max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
                        <div class="mt-2"><a href="{{ route('post.show', [$post->id]) }}"
                                             class="text-2xl text-gray-700 font-bold hover:underline">{{ $post->title }}</a>
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <a href="{{ route('post.show', [$post->id]) }}"
                               class="text-blue-500 hover:underline">もっと見る</a>
